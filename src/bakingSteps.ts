...
export const rzSchritt3:string = `<ul class="zutatenListe"></ul>
                              <li>3 Eier (Gr. M)</li>
                              <li>150 g Zucker</li>
                              <li>200 g weiche Butter</li>
                              <li>500 g Magerquark</li>
...
export const ekSchritt2:string = `<p>Den Teig auf einem mit Backpapier ausgelegten Backblech verteilen und bei 180 °C Ober-/Unterhitze im vorgeheizten Ofen 25 Minuten backen.</p>`;
