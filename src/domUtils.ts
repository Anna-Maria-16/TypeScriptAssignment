...
export const schritt3RZ = document.getElementById('rz3') as HTMLElement;
export const schritt4RZ = document.getElementById('rz4') as HTMLElement;

export const schritt1EK = document.getElementById('ek1') as HTMLElement;
export const schritt2EK = document.getElementById('ek2') as HTMLElement;
